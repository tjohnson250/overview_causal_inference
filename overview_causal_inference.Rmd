...
imp <- impliedConditionalIndependencies( gmonica, type = "basis.set", max.results = Inf )
imp
```
]
...
```
???
The implied independencies shown in earlier slides are not the basis set for this graph. 'dagitty' can produce a basis set as shown here, but its localTests cannot be forced to test the basis set. 
---
# Limitations
